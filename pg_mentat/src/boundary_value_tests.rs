...
mod boundary_value_tests {
    ...
    fn test_bv_long_zero() {
        setup(); setup_bv_schema();
        let r = Spi::get_one::<String>("SELECT mentat_transact('[[:db/add \"e\" :bv/lng 0]]'::TEXT)").expect("tx").expect("NULL");
    ...
    fn test_bv_long_one() {
        setup(); setup_bv_schema();
        let r = Spi::get_one::<String>("SELECT mentat_transact('[[:db/add \"e\" :bv/lng 1]]'::TEXT)").expect("tx").expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :bv/lng ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
        let v: serde_json::Value = serde_json::from_str(&q).expect("parse");
    ...
    fn test_bv_long_max_i32() {
        ...
        let r = Spi::get_one::<String>(&format!("SELECT mentat_transact('[[:db/add \"e\" :bv/lng {}]]'::TEXT)", val)).expect("tx").expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :bv/lng ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
        let v: serde_json::Value = serde_json::from_str(&q).expect("parse");
    ...
    fn test_bv_long_max_i64() {
        setup(); setup_bv_schema();
        let r = Spi::get_one::<String>(&format!("SELECT mentat_transact('[[:db/add \"e\" :bv/lng {}]]'::TEXT)", i64::MAX)).expect("tx").expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :bv/lng ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
        let v: serde_json::Value = serde_json::from_str(&q).expect("parse");
    ...
    fn test_bv_long_min_i64() {
        setup(); setup_bv_schema();
        let r = Spi::get_one::<String>(&format!("SELECT mentat_transact('[[:db/add \"e\" :bv/lng {}]]'::TEXT)", i64::MIN)).expect("tx").expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :bv/lng ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
        let v: serde_json::Value = serde_json::from_str(&q).expect("parse");
    ...
    fn test_bv_long_powers_of_10() {
        ...
        for exp in 0..18u32 {
            ...
            let r = Spi::get_one::<String>(&format!("SELECT mentat_transact('[[:db/add \"p{exp}\" :bv/lng {val}]]'::TEXT)", exp=exp, val=val)).expect("tx").expect("NULL");
            let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
            let eid = j["tempids"][&format!("p{}", exp)].as_i64().expect("eid");
            let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :bv/lng ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
            let v: serde_json::Value = serde_json::from_str(&q).expect("parse");
            assert_eq!(v["result"].as_i64().expect("v"), val, "10^{} should roundtrip", exp);
        }
    }
    ...
    fn test_bv_long_negative_powers_of_10() {
        ...
        for exp in 0..18u32 {
            ...
            let r = Spi::get_one::<String>(&format!("SELECT mentat_transact('[[:db/add \"{}\" :bv/lng {}]]'::TEXT)", label, val)).expect("tx").expect("NULL");
            let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
    ...
    fn test_bv_long_around_zero() {
        setup(); setup_bv_schema();
        for val in -10i64..=10 {
            let label = if val >= 0 { format!("p{}", val) } else { format!("n{}", val.unsigned_abs()) };
            let r = Spi::get_one::<String>(&format!("SELECT mentat_transact('[[:db/add \"{}\" :bv/lng {}]]'::TEXT)", label, val)).expect("tx").expect("NULL");
            let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
            let eid = j["tempids"][&label].as_i64().expect("eid");
            let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :bv/lng ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
    ...
    fn test_bv_dbl_zero() {
        setup(); setup_bv_schema();
        let r = Spi::get_one::<String>("SELECT mentat_transact('[[:db/add \"e\" :bv/dbl 0.0]]'::TEXT)").expect("tx").expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
    ...
    fn test_bv_dbl_one() {
        setup(); setup_bv_schema();
        let r = Spi::get_one::<String>("SELECT mentat_transact('[[:db/add \"e\" :bv/dbl 1.0]]'::TEXT)").expect("tx").expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :bv/dbl ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
        let v: serde_json::Value = serde_json::from_str(&q).expect("parse");
    ...
    fn test_bv_dbl_epsilon() {
        setup(); setup_bv_schema();
        let r = Spi::get_one::<String>("SELECT mentat_transact('[[:db/add \"e\" :bv/dbl 0.000000001]]'::TEXT)").expect("tx").expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :bv/dbl ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
        let v: serde_json::Value = serde_json::from_str(&q).expect("parse");
    ...
    fn test_bv_dbl_large() {
        setup(); setup_bv_schema();
        let r = Spi::get_one::<String>("SELECT mentat_transact('[[:db/add \"e\" :bv/dbl 1.0e15]]'::TEXT)").expect("tx").expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :bv/dbl ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
        let v: serde_json::Value = serde_json::from_str(&q).expect("parse");
    ...
    fn test_bv_dbl_fractional_progression() {
        ...
        for i in 1..=9 {
            ...
            let r = Spi::get_one::<String>(&format!("SELECT mentat_transact('[[:db/add \"f{}\" :bv/dbl {}]]'::TEXT)", i, val)).expect("tx").expect("NULL");
            let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
            let eid = j["tempids"][&format!("f{}", i)].as_i64().expect("eid");
            let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :bv/dbl ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
            let v: serde_json::Value = serde_json::from_str(&q).expect("parse");
            assert!((v["result"].as_f64().expect("v") - val).abs() < 0.01, "0.{} should roundtrip", i);
        }
    }
    ...
    fn test_bv_str_empty() {
        setup(); setup_bv_schema();
        let r = Spi::get_one::<String>("SELECT mentat_transact('[[:db/add \"e\" :bv/str \"\"]]'::TEXT)").expect("tx").expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
    ...
    fn test_bv_str_single_char() {
        setup(); setup_bv_schema();
        let r = Spi::get_one::<String>("SELECT mentat_transact('[[:db/add \"e\" :bv/str \"a\"]]'::TEXT)").expect("tx").expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :bv/str ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
        let v: serde_json::Value = serde_json::from_str(&q).expect("parse");
    ...
    fn test_bv_str_lengths_1_to_100() {
        ...
        for len in [1, 2, 5, 10, 25, 50, 100] {
            ...
            let r = Spi::get_one::<String>(&format!("SELECT mentat_transact('[[:db/add \"l{}\" :bv/str \"{}\"]]'::TEXT)", len, s)).expect("tx").expect("NULL");
            let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
            let eid = j["tempids"][&format!("l{}", len)].as_i64().expect("eid");
            let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :bv/str ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
            let v: serde_json::Value = serde_json::from_str(&q).expect("parse");
            assert_eq!(v["result"].as_str().expect("s").len(), len, "len {} roundtrip", len);
        }
    }
    ...
    fn test_bv_str_1000_chars() {
        ...
        let r = Spi::get_one::<String>(&format!("SELECT mentat_transact('[[:db/add \"e\" :bv/str \"{}\"]]'::TEXT)", s)).expect("tx").expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :bv/str ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
        let v: serde_json::Value = serde_json::from_str(&q).expect("parse");
    ...
    fn test_bv_str_10000_chars() {
        setup(); setup_bv_schema();
        let s: String = (0..10000).map(|i| (b'a' + (i % 26) as u8) as char).collect();
        let r = Spi::get_one::<String>(&format!("SELECT mentat_transact('[[:db/add \"e\" :bv/str \"{}\"]]'::TEXT)", s)).expect("tx").expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :bv/str ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
    ...
    fn test_bv_str_whitespace_variations() {
        ...
        for (label, val) in cases {
            let r = Spi::get_one::<String>(&format!("SELECT mentat_transact('[[:db/add \"{}\" :bv/str \"{}\"]]'::TEXT)", label, val)).expect("tx").expect("NULL");
            let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
            let eid = j["tempids"][label].as_i64().expect("eid");
            let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :bv/str ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
            let v: serde_json::Value = serde_json::from_str(&q).expect("parse");
            assert_eq!(v["result"].as_str().expect("s"), val, "{} should preserve whitespace", label);
        }
    }
    ...
    fn test_bv_many_zero_values() {
        setup(); setup_bv_schema();
        let r = Spi::get_one::<String>("SELECT mentat_transact('[[:db/add \"e\" :bv/str \"holder\"]]'::TEXT)").expect("tx").expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
    ...
    fn test_bv_many_longs_boundary_values() {
        ...
        let v: serde_json::Value = serde_json::from_str(&q).expect("parse");
        assert_eq!(v["result"].as_array().expect("arr").len(), boundary_vals.len());
    }
    ...
    fn test_bv_batch_1_entity() {
        setup(); setup_bv_schema();
        let r = Spi::get_one::<String>("SELECT mentat_transact('[[:db/add \"e\" :bv/str \"one\"]]'::TEXT)").expect("tx").expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
    ...
    fn test_bv_batch_10_entities() {
        setup(); setup_bv_schema();
        let mut ops = Vec::new();
        for i in 0..10 { ops.push(format!("[:db/add \"b{}\" :bv/str \"e-{}\"]", i, i)); }
    ...
    fn test_bv_batch_50_entities() {
        setup(); setup_bv_schema();
        let mut ops = Vec::new();
        for i in 0..50 { ops.push(format!("[:db/add \"b{}\" :bv/str \"e-{}\"]", i, i)); }
        let r = Spi::get_one::<String>(&format!("SELECT mentat_transact('[{}]'::TEXT)", ops.join("\n"))).expect("tx").expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
    ...
    fn test_bv_batch_100_entities() {
        setup(); setup_bv_schema();
        let mut ops = Vec::new();
        for i in 0..100 { ops.push(format!("[:db/add \"b{}\" :bv/str \"e-{}\"]", i, i)); }
        let r = Spi::get_one::<String>(&format!("SELECT mentat_transact('[{}]'::TEXT)", ops.join("\n"))).expect("tx").expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
    ...
    fn test_bv_batch_500_entities() {
        setup(); setup_bv_schema();
        let mut ops = Vec::new();
        for i in 0..500 { ops.push(format!("[:db/add \"b{}\" :bv/str \"e-{}\"]", i, i)); }
        Spi::run(&format!("SELECT mentat_transact('[{}]'::TEXT)", ops.join("\n"))).expect("tx");
    ...
    fn test_bv_update_100_times() {
        ...
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        for i in 1..=100 {
            Spi::run(&format!("SELECT mentat_transact('[[:db/add {} :bv/lng {}]]'::TEXT)", eid, i)).expect("update");
        }
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :bv/lng ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
        let v: serde_json::Value = serde_json::from_str(&q).expect("parse");
