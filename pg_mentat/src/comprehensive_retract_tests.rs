...
mod tests {
    ...
    fn test_cr_retract_string() {
        ...
        let r = Spi::get_one::<String>(
            "SELECT mentat_transact('[[:db/add \"e\" :cr/name \"gone\"]]'::TEXT)",
        )
        .expect("tx")
        .expect("NULL");
        ...
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/name \"gone\"]]'::TEXT)",
            eid
        ))
        .expect("retract");
    ...
    fn test_cr_retract_empty_string() {
        ...
        setup_cr_schema();
        let r = Spi::get_one::<String>(
            "SELECT mentat_transact('[[:db/add \"e\" :cr/name \"\"]]'::TEXT)",
        )
        .expect("tx")
        .expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/name \"\"]]'::TEXT)",
            eid
        ))
        .expect("retract");
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :cr/name ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
    ...
    fn test_cr_retract_long_positive() {
        ...
        setup_cr_schema();
        let r =
            Spi::get_one::<String>("SELECT mentat_transact('[[:db/add \"e\" :cr/val 42]]'::TEXT)")
                .expect("tx")
                .expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/val 42]]'::TEXT)",
            eid
        ))
        .expect("retract");
        let q = Spi::get_one::<String>(&format!(
            "SELECT mentat_query('[:find ?v . :where [{} :cr/val ?v]]'::TEXT, '{{}}'::jsonb)::TEXT",
            eid
        ))
        .expect("q")
        .expect("NULL");
    ...
    fn test_cr_retract_long_negative() {
        ...
        setup_cr_schema();
        let r = Spi::get_one::<String>(
            "SELECT mentat_transact('[[:db/add \"e\" :cr/val -999]]'::TEXT)",
        )
        .expect("tx")
        .expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/val -999]]'::TEXT)",
            eid
        ))
        .expect("retract");
        let q = Spi::get_one::<String>(&format!(
    ...
    fn test_cr_retract_long_zero() {
        ...
        setup_cr_schema();
        let r =
            Spi::get_one::<String>("SELECT mentat_transact('[[:db/add \"e\" :cr/val 0]]'::TEXT)")
                .expect("tx")
                .expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/val 0]]'::TEXT)",
            eid
        ))
        .expect("retract");
        let q = Spi::get_one::<String>(&format!(
    ...
    fn test_cr_retract_bool_true() {
        ...
        setup_cr_schema();
        let r = Spi::get_one::<String>(
            "SELECT mentat_transact('[[:db/add \"e\" :cr/flag true]]'::TEXT)",
        )
        .expect("tx")
        .expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/flag true]]'::TEXT)",
            eid
        ))
        .expect("retract");
    ...
    fn test_cr_retract_bool_false() {
        ...
        setup_cr_schema();
        let r = Spi::get_one::<String>(
            "SELECT mentat_transact('[[:db/add \"e\" :cr/flag false]]'::TEXT)",
        )
        .expect("tx")
        .expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/flag false]]'::TEXT)",
            eid
        ))
        .expect("retract");
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :cr/flag ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
    ...
    fn test_cr_retract_double() {
        ...
        setup_cr_schema();
        let r = Spi::get_one::<String>(
            "SELECT mentat_transact('[[:db/add \"e\" :cr/dbl 3.14]]'::TEXT)",
        )
        .expect("tx")
        .expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/dbl 3.14]]'::TEXT)",
            eid
        ))
        .expect("retract");
        let q = Spi::get_one::<String>(&format!(
            "SELECT mentat_query('[:find ?v . :where [{} :cr/dbl ?v]]'::TEXT, '{{}}'::jsonb)::TEXT",
            eid
        ))
        .expect("q")
        .expect("NULL");
    ...
    fn test_cr_retract_keyword() {
        ...
        setup_cr_schema();
        let r = Spi::get_one::<String>(
            "SELECT mentat_transact('[[:db/add \"e\" :cr/kw :active]]'::TEXT)",
        )
        .expect("tx")
        .expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/kw :active]]'::TEXT)",
            eid
        ))
        .expect("retract");
        let q = Spi::get_one::<String>(&format!(
            "SELECT mentat_query('[:find ?v . :where [{} :cr/kw ?v]]'::TEXT, '{{}}'::jsonb)::TEXT",
            eid
        ))
        .expect("q")
        .expect("NULL");
    ...
    fn test_cr_retract_entity_with_string() {
        ...
        setup_cr_schema();
        let r = Spi::get_one::<String>(
            "SELECT mentat_transact('[{:db/id \"e\" :cr/name \"doomed\"}]'::TEXT)",
        )
        .expect("tx")
        .expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
    ...
    fn test_cr_batch_retract_entity_10() {
        ...
        for i in 0..10 {
            ops.push(format!(
                "{{:db/id \"e{i}\" :cr/name \"doomed-{i}\" :cr/val {i}}}",
                i = i
            ));
        }
    ...
    fn test_cr_retract_one_of_many_strings() {
        ...
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/tags \"b\"]]'::TEXT)",
            eid
        ))
        .expect("retract");
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find [?t ...] :where [{} :cr/tags ?t]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
    ...
    fn test_cr_retract_all_many_one_by_one() {
        ...
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/tags \"x\"]]'::TEXT)",
            eid
        ))
        .expect("r1");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/tags \"y\"]]'::TEXT)",
            eid
        ))
        .expect("r2");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/tags \"z\"]]'::TEXT)",
            eid
        ))
        .expect("r3");
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find [?t ...] :where [{} :cr/tags ?t]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
    ...
    fn test_cr_retract_many_nums() {
        ...
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/nums 20]]'::TEXT)",
            eid
        ))
        .expect("retract");
    ...
    fn test_cr_retract_many_refs_one() {
        ...
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/refs {}]]'::TEXT)",
            hub, s1
        ))
        .expect("retract ref");
    ...
    fn test_cr_retract_readd_string() {
        ...
        setup_cr_schema();
        let r = Spi::get_one::<String>(
            "SELECT mentat_transact('[[:db/add \"e\" :cr/name \"test\"]]'::TEXT)",
        )
        .expect("tx")
        .expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/name \"test\"]]'::TEXT)",
            eid
        ))
        .expect("retract");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/add {} :cr/name \"test\"]]'::TEXT)",
            eid
        ))
        .expect("readd");
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find ?v . :where [{} :cr/name ?v]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
    ...
    fn test_cr_retract_readd_different_value() {
        ...
        setup_cr_schema();
        let r =
            Spi::get_one::<String>("SELECT mentat_transact('[[:db/add \"e\" :cr/val 10]]'::TEXT)")
                .expect("tx")
                .expect("NULL");
        let j: serde_json::Value = serde_json::from_str(&r).expect("parse");
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/val 10]]'::TEXT)",
            eid
        ))
        .expect("retract");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/add {} :cr/val 99]]'::TEXT)",
            eid
        ))
        .expect("readd");
        let q = Spi::get_one::<String>(&format!(
    ...
    fn test_cr_retract_readd_many() {
        ...
        let eid = j["tempids"]["e"].as_i64().expect("eid");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/retract {} :cr/tags \"tag1\"]]'::TEXT)",
            eid
        ))
        .expect("retract");
        Spi::run(&format!(
            "SELECT mentat_transact('[[:db/add {} :cr/tags \"tag1\"]]'::TEXT)",
            eid
        ))
        .expect("readd");
        let q = Spi::get_one::<String>(&format!("SELECT mentat_query('[:find [?t ...] :where [{} :cr/tags ?t]]'::TEXT, '{{}}'::jsonb)::TEXT", eid)).expect("q").expect("NULL");
